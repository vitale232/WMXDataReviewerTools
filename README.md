...
3. These validations are executed against the entire LRSN_Milepoint table, validating only active routes. There are two SQL queries that are executed as apart of this validation tool, one of which ensures thare is only one combination of roadway-level attributes, the other of which ensures there is not more than one combination of `DOT_ID, COUNTY_ORDER, and DIRECTION`.
...
### Milepoint Checks
| Invalid Geometry                                                        | Invalid Geometry                      | TO\_DATE IS NULL                                                                                                            |
|-------------------------------------------------------------------------|---------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|
| Non\-Linear Segments                                                    | Non\-Linear Segment                   | TO\_DATE IS NULL                                                                                                            |
| Self\-Intersection Check                                                | Polyline or Path Closes on Self Check | TO\_DATE IS NULL                                                                                                            |
| Domain Check                                                            | Domain Check                          | TO\_DATE IS NULL                                                                                                            |
| Duplicate Vertices                                                      | Duplicate Vertices                    | TO\_DATE IS NULL                                                                                                            | Tolerance: 0\.0011 meters        |
| Calibration Point on Routes                                             | Geometry on Geometry                  | TO\_DATE IS NULL                                                                                                            | "FC1: Calibration Points         |
| FC2: Milepoint                                                          |
| Tolerance: 0\.0011 meters                                               |
| Compare Attributes: Milepoint\.ROUTE\_ID=Calibration\_Point\.ROUTE\_ID" |
| Cutbacks                                                                | Cutbacks Check                        | TO\_DATE IS NULL                                                                                                            | Min angle in degrees: 30         |
| Length Check                                                            | Evaluate Polyline Length Check        | TO\_DATE IS NULL                                                                                                            | "Type: Polyline                  |
| Length: <=0\.001 miles"                                                 |
| Dangles                                                                 | Find Dangles                          | TO\_DATE IS NULL                                                                                                            | Dangle Tolerance: 0\.009 miles   |
| Monotinicity Check                                                      | Monotinicity Check                    | TO\_DATE IS NULL                                                                                                            | "Evalueate: M values             |
| Search Goal: Non\-monotonic features/Decreasing Values"                 |
...
| Local Road Overlap                                                      | Geometry on Geometry                  | ROADWAY\_TYPE = 1 AND TO\_DATE IS NULL                                                                                      | "where\_clause: Same on both FCs |
| FC1: Milepoint                                                          |
| FC2: Milepoint                                                          |
| Spatial Relation Check type: Overlaps                                   |
| Compare Attributes: CONC\_HIERARCHY=CONC\_HIERARCHY"                    |
| Route Not on Centerline                                                 | Geometry on Geometry                  | TO\_DATE IS NULL                                                                                                            | "where\_clause: FC1 blank        |
| FC1: Centerlines                                                        |
| FC2: Milepoint                                                          |
| Spatial Relation Check Type: Within                                     |
| Attributes: None"                                                       |
